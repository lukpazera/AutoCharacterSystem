...
class ViewUtils(object):
    ...
    def get3DPositionFromMouseOver3DView(cls):
        ...
        # There's some mess with python 3 here.
        # The lxu.decodeID4 returns byte array (b'string') prior in MODO 15.x when using python3.
        # So we need to try and decode that into string.
        # If it fails then it's either python 2 or
        # it's MODO 16 and python3 that has this stuff fixed.
        try:
